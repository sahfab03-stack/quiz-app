...
questions = [
    ...
    ("ISRO का मुख्यालय कहाँ स्थित है?",
     ["मुंबई", "नई दिल्ली", "बेंगलुरु", "चेन्नई"], "बेंगलुरु"),

    ("भारत का राष्ट्रीय खेल कौन सा है?",
     ["क्रिकेट", "हॉकी", "कबड्डी", "फुटबॉल"], "हॉकी"),

    ("संयुक्त राष्ट्र दिवस कब मनाया जाता है?",
     ["24 अक्टूबर", "10 दिसंबर", "5 जून", "15 अगस्त"], "24 अक्टूबर"),

    ("विश्व स्वास्थ्य संगठन (WHO) की स्थापना कब हुई?",
     ["1945", "1948", "1950", "1960"], "1948"),

    ("भारत की सबसे लंबी नदी कौन सी है?",
     ["यमुना", "गंगा", "ब्रह्मपुत्र", "गोदावरी"], "गंगा"),

    ("भारतीय संविधान कब लागू हुआ?",
     ["15 अगस्त 1947", "26 जनवरी 1950", "2 अक्टूबर 1948", "26 नवंबर 1949"], "26 जनवरी 1950"),

    ("नासा किस देश की अंतरिक्ष एजेंसी है?",
     ["रूस", "अमेरिका", "जापान", "फ्रांस"], "अमेरिका"),

    ("ओलंपिक खेल कितने वर्ष में आयोजित होते हैं?",
     ["2 वर्ष", "3 वर्ष", "4 वर्ष", "5 वर्ष"], "4 वर्ष"),

    ("भारत के पहले प्रधानमंत्री कौन थे?",
     ["महात्मा गांधी", "जवाहरलाल नेहरू", "सरदार पटेल", "राजेंद्र प्रसाद"], "जवाहरलाल नेहरू"),

    ("विश्व बैंक का मुख्यालय कहाँ है?",
     ["लंदन", "वॉशिंगटन डीसी", "न्यूयॉर्क", "जिनेवा"], "वॉशिंगटन डीसी"),

    ("किस देश ने फीफा विश्व कप 2022 जीता?",
     ["फ्रांस", "ब्राज़ील", "अर्जेंटीना", "जर्मनी"], "अर्जेंटीना"),

    ("भारत का राष्ट्रीय पशु कौन है?",
     ["सिंह", "बाघ", "हाथी", "गैंडा"], "बाघ"),

    ("GST भारत में कब लागू हुआ?",
     ["2016", "2017", "2018", "2019"], "2017"),

    ("भारत का सबसे बड़ा राज्य क्षेत्रफल के आधार पर कौन सा है?",
     ["मध्य प्रदेश", "राजस्थान", "उत्तर प्रदेश", "महाराष्ट्र"], "राजस्थान"),

    ("हाल ही में भारत के मुख्य चुनाव आयुक्त कौन हैं?",
     ["राजीव कुमार", "अरुण गोयल", "सुनिल अरोड़ा", "ओम प्रकाश रावत"], "राजीव कुमार"),
]
